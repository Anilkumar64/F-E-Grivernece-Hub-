...
const userSchema = new mongoose.Schema(
    {
        ...
        phoneVerificationCode: { type: String, select: false, default: null },
        phoneVerificationExpires: { type: Date, select: false, default: null },
        emailVerified: { type: Boolean, default: false },
        phoneVerified: { type: Boolean, default: false },
        preferredVerification: { type: String, enum: ['email', 'phone'], default: 'email' },
