...
const grievanceSchema = new mongoose.Schema(
    {
        ...
        assignedTo: { type: mongoose.Schema.Types.ObjectId, refPath: "assignedToModel", default: null, index: true },
        assignedToModel: { type: String, enum: ["Admin", "SuperAdmin"], default: "Admin" },
